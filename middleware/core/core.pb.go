...
type BaseResponse struct {
	...
	Code          int32                  `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty" yaml:"code,omitempty" toml:"code,omitempty" gorm:"not null;default:0;column:code"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty" toml:"message,omitempty" gorm:"type:varchar(255);not null;default:'';column:message" yaml:"message,omitempty"`
...
type RawReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Body          []byte                 `protobuf:"bytes,1,opt,name=body,proto3" json:"body,omitempty" yaml:"body,omitempty" toml:"body,omitempty" gorm:"type:json;serializer:json;column:body"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type RawRsp struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Body  []byte                 `protobuf:"bytes,1,opt,name=body,proto3" json:"body,omitempty" yaml:"body,omitempty" toml:"body,omitempty" gorm:"column:body;type:json;serializer:json"`
	// 不填会按照纯文本处理
...
type ServiceDiscoveryClient struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DiscoveryType DiscoveryType          `protobuf:"varint,1,opt,name=discovery_type,json=discoveryType,proto3,enum=lazygophers.lrpc.core.DiscoveryType" json:"discovery_type,omitempty" toml:"discovery_type,omitempty" gorm:"not null;default:0;column:discovery_type" yaml:"discovery_type,omitempty"`
	// 当 type = none 时生效
	Url           []string             `protobuf:"bytes,2,rep,name=url,proto3" json:"url,omitempty" yaml:"url,omitempty" toml:"url,omitempty" gorm:"column:url;type:json;serializer:json"`
	ServiceName   string               `protobuf:"bytes,3,opt,name=service_name,json=serviceName,proto3" json:"service_name,omitempty" yaml:"service_name,omitempty" toml:"service_name,omitempty" gorm:"type:varchar(255);not null;default:'';column:service_name"`
	ServicePath   string               `protobuf:"bytes,4,opt,name=service_path,json=servicePath,proto3" json:"service_path,omitempty" toml:"service_path,omitempty" gorm:"type:varchar(255);not null;default:'';column:service_path" yaml:"service_path,omitempty"`
	...
	Timeout       *durationpb.Duration `protobuf:"bytes,6,opt,name=timeout,proto3" json:"timeout,omitempty" yaml:"timeout,omitempty" toml:"timeout,omitempty" gorm:"column:timeout"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ServiceDiscoveryService struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	ServiceName   string                  `protobuf:"bytes,1,opt,name=service_name,json=serviceName,proto3" json:"service_name,omitempty" yaml:"service_name,omitempty" toml:"service_name,omitempty" gorm:"not null;default:'';column:service_name;type:varchar(255)"`
	NodeList      []*ServiceDiscoveryNode `protobuf:"bytes,2,rep,name=node_list,json=nodeList,proto3" json:"node_list,omitempty" toml:"node_list,omitempty" gorm:"type:json;serializer:json;column:node_list" yaml:"node_list,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ServiceDiscoveryNode struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Type          ServiceType            `protobuf:"varint,1,opt,name=type,proto3,enum=lazygophers.lrpc.core.ServiceType" json:"type,omitempty" yaml:"type,omitempty" toml:"type,omitempty" gorm:"default:0;column:type;not null"`
	Host          string                 `protobuf:"bytes,2,opt,name=host,proto3" json:"host,omitempty" gorm:"type:varchar(255);not null;default:'';column:host" yaml:"host,omitempty" toml:"host,omitempty"`
	Port          string                 `protobuf:"bytes,3,opt,name=port,proto3" json:"port,omitempty" gorm:"type:varchar(255);not null;default:'';column:port" yaml:"port,omitempty" toml:"port,omitempty"`
	...
	Password      string                 `protobuf:"bytes,5,opt,name=password,proto3" json:"password,omitempty" yaml:"password,omitempty" toml:"password,omitempty" gorm:"type:varchar(255);not null;default:'';column:password"`
...
type ConfigItem struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           string                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty" toml:"key,omitempty" gorm:"not null;default:'';column:key;type:varchar(255)" yaml:"key,omitempty"`
...
type ListOption struct {
	...
	// @desc: 这一页的起始索引
	// @example: 0
	Offset uint64 `protobuf:"varint,1,opt,name=offset,proto3" json:"offset,omitempty" gorm:"default:0;column:offset;not null" desc:"这一页的起始索引" example:"0" yaml:"offset,omitempty" toml:"offset,omitempty"`
	// @desc: 每一页的数量
	// @example: 10
	Limit uint64 `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty" desc:"每一页的数量" example:"10" yaml:"limit,omitempty" toml:"limit,omitempty" gorm:"not null;default:0;column:limit"`
	// @desc: 是否返回总数
	// @example: true
	ShowTotal bool `protobuf:"varint,3,opt,name=show_total,json=showTotal,proto3" json:"show_total,omitempty" toml:"show_total,omitempty" gorm:"default:0;not null;type:tinyint(1);column:show_total" desc:"是否返回总数" example:"true" yaml:"show_total,omitempty"`
	// @desc: 游标，用于分页，如果有优先使用 cursor
	Cursor string `protobuf:"bytes,5,opt,name=cursor,proto3" json:"cursor,omitempty" desc:"游标，用于分页，如果有优先使用cursor" yaml:"cursor,omitempty" toml:"cursor,omitempty" gorm:"type:varchar(255);not null;default:'';column:cursor"`
	// @desc: 过滤条件
	Options       []*ListOption_Option `protobuf:"bytes,4,rep,name=options,proto3" json:"options,omitempty" desc:"过滤条件" yaml:"options,omitempty" toml:"options,omitempty" gorm:"type:json;serializer:json;column:options"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Paginate struct {
	...
	// @desc: 这一页的起始索引
	// @example: 0
	Offset uint64 `protobuf:"varint,1,opt,name=offset,proto3" json:"offset,omitempty" toml:"offset,omitempty" gorm:"not null;default:0;column:offset" desc:"这一页的起始索引" example:"0" yaml:"offset,omitempty"`
	// @desc: 每一页的数量
	// @example: 10
	Limit uint64 `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty" gorm:"not null;default:0;column:limit" desc:"每一页的数量" example:"10" yaml:"limit,omitempty" toml:"limit,omitempty"`
	// @desc: 总数，只有传入 show_total 为 true 时才会返回
	// @example: 100
	Total uint64 `protobuf:"varint,3,opt,name=total,proto3" json:"total,omitempty" desc:"总数，只有传入show_total为true时才会返回" example:"100" yaml:"total,omitempty" toml:"total,omitempty" gorm:"default:0;column:total;not null"`
	// @desc: 下一页的游标，用于分页，如果有优先使用 cursor
	NextCursor    string `protobuf:"bytes,4,opt,name=next_cursor,json=nextCursor,proto3" json:"next_cursor,omitempty" desc:"下一页的游标，用于分页，如果有优先使用cursor" yaml:"next_cursor,omitempty" toml:"next_cursor,omitempty" gorm:"type:varchar(255);not null;default:'';column:next_cursor"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Http struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Method        *string                `protobuf:"bytes,1,opt,name=method,proto3,oneof" json:"method,omitempty" gorm:"type:json;serializer:json;column:method" yaml:"method,omitempty" toml:"method,omitempty"`
	Path          *string                `protobuf:"bytes,2,opt,name=path,proto3,oneof" json:"path,omitempty" toml:"path,omitempty" gorm:"type:json;serializer:json;column:path" yaml:"path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LazyGen struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	RoleList       []string               `protobuf:"bytes,1,rep,name=role_list,json=roleList,proto3" json:"role_list,omitempty" toml:"role_list,omitempty" gorm:"type:json;serializer:json;column:role_list" yaml:"role_list,omitempty"`                   // 角色，如 admin/user/public 等
	...
	AfterHandlers  []string               `protobuf:"bytes,4,rep,name=after_handlers,json=afterHandlers,proto3" json:"after_handlers,omitempty" yaml:"after_handlers,omitempty" toml:"after_handlers,omitempty" gorm:"type:json;serializer:json;column:after_handlers"`    // 后置拦截器
	Group          string                 `protobuf:"bytes,5,opt,name=group,proto3" json:"group,omitempty" yaml:"group,omitempty" toml:"group,omitempty" gorm:"not null;default:'';column:group;type:varchar(255)"`                                         // 分组
	Name           string                 `protobuf:"bytes,6,opt,name=name,proto3" json:"name,omitempty" yaml:"name,omitempty" toml:"name,omitempty" gorm:"column:name;type:varchar(255);not null;default:''"`                                           // 接口名
	Desc           string                 `protobuf:"bytes,7,opt,name=desc,proto3" json:"desc,omitempty" yaml:"desc,omitempty" toml:"desc,omitempty" gorm:"default:'';column:desc;type:varchar(255);not null"`                                           // 接口描述
	Docs           string                 `protobuf:"bytes,8,opt,name=docs,proto3" json:"docs,omitempty" gorm:"default:'';column:docs;type:varchar(255);not null" yaml:"docs,omitempty" toml:"docs,omitempty"`                                           // 接口文档，长文本的消息描述
	Action         string                 `protobuf:"bytes,9,opt,name=action,proto3" json:"action,omitempty" yaml:"action,omitempty" toml:"action,omitempty" gorm:"type:varchar(255);not null;default:'';column:action"`                                       // 操作，用于根据 action 寻找对应的模板
	Model          string                 `protobuf:"bytes,10,opt,name=model,proto3" json:"model,omitempty" yaml:"model,omitempty" toml:"model,omitempty" gorm:"type:varchar(255);not null;default:'';column:model"`                                        // 模型
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type ListOption_Option struct {
	...
	// @example: 1
	Key int32 `protobuf:"varint,1,opt,name=key,proto3" json:"key,omitempty" gorm:"default:0;column:key;not null" desc:"键值对，描述过滤的条件，一般为请求接口的ListOption枚举" example:"1" yaml:"key,omitempty" toml:"key,omitempty"`
	// @desc: 过滤的条件
	// @example: "true"
	Value         string `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" toml:"value,omitempty" gorm:"column:value;type:varchar(255);not null;default:''" desc:"过滤的条件" example:"true" yaml:"value,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_core_proto_rawDesc = "" +
	...
	"\aversion\x18\x03 \x01(\x03R\aversion\"\xe7\x01\n" +
	"\n" +
	"ListOption\x12\x16\n" +
	"\x06offset\x18\x01 \x01(\x04R\x06offset\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x04R\x05limit\x12\x1d\n" +
	"\n" +
	"show_total\x18\x03 \x01(\bR\tshowTotal\x12\x16\n" +
	"\x06cursor\x18\x05 \x01(\tR\x06cursor\x12B\n" +
	...
	"\x04docs\x18\b \x01(\tR\x04docs\x12\x16\n" +
	"\x06action\x18\t \x01(\tR\x06action\x12\x14\n" +
	"\x05model\x18\n" +
	" \x01(\tR\x05model*\x83\x0e\n" +
	"\aErrCode\x12\v\n" +
