...
type BaseResponse struct {
	...
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty" yaml:"message,omitempty" toml:"message,omitempty" gorm:"type:varchar(255);not null;default:'';column:message"`
	...
	Hint          string                 `protobuf:"bytes,4,opt,name=hint,proto3" json:"hint,omitempty" toml:"hint,omitempty" gorm:"type:varchar(255);not null;default:'';column:hint" yaml:"hint,omitempty"`
...
type RawRsp struct {
	...
	// 不填会按照纯文本处理
	ContentType   string `protobuf:"bytes,2,opt,name=content_type,json=contentType,proto3" json:"content_type,omitempty" toml:"content_type,omitempty" gorm:"type:varchar(255);not null;default:'';column:content_type" yaml:"content_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ServiceDiscoveryClient struct {
	...
	// 当 type = none 时生效
	Url           []string             `protobuf:"bytes,2,rep,name=url,proto3" json:"url,omitempty" yaml:"url,omitempty" toml:"url,omitempty" gorm:"type:json;serializer:json;column:url"`
	...
	ServicePath   string               `protobuf:"bytes,4,opt,name=service_path,json=servicePath,proto3" json:"service_path,omitempty" yaml:"service_path,omitempty" toml:"service_path,omitempty" gorm:"default:'';column:service_path;type:varchar(255);not null"`
	Method        string               `protobuf:"bytes,5,opt,name=method,proto3" json:"method,omitempty" yaml:"method,omitempty" toml:"method,omitempty" gorm:"not null;default:'';column:method;type:varchar(255)"`
...
type ServiceDiscoveryService struct {
	state         protoimpl.MessageState  `protogen:"open.v1"`
	ServiceName   string                  `protobuf:"bytes,1,opt,name=service_name,json=serviceName,proto3" json:"service_name,omitempty" yaml:"service_name,omitempty" toml:"service_name,omitempty" gorm:"column:service_name;type:varchar(255);not null;default:''"`
	NodeList      []*ServiceDiscoveryNode `protobuf:"bytes,2,rep,name=node_list,json=nodeList,proto3" json:"node_list,omitempty" yaml:"node_list,omitempty" toml:"node_list,omitempty" gorm:"type:json;serializer:json;column:node_list"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ServiceDiscoveryNode struct {
	...
	Port          string                 `protobuf:"bytes,3,opt,name=port,proto3" json:"port,omitempty" yaml:"port,omitempty" toml:"port,omitempty" gorm:"type:varchar(255);not null;default:'';column:port"`
	Username      string                 `protobuf:"bytes,4,opt,name=username,proto3" json:"username,omitempty" yaml:"username,omitempty" toml:"username,omitempty" gorm:"type:varchar(255);not null;default:'';column:username"`
...
type ConfigItem struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           string                 `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty" yaml:"key,omitempty" toml:"key,omitempty" gorm:"type:varchar(255);not null;default:'';column:key"`
	Value         []byte                 `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" toml:"value,omitempty" gorm:"type:json;serializer:json;column:value" yaml:"value,omitempty"`
...
type ListOption struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Offset        uint64                 `protobuf:"varint,1,opt,name=offset,proto3" json:"offset,omitempty" toml:"offset,omitempty" gorm:"not null;default:0;column:offset" yaml:"offset,omitempty"`
	...
	ShowTotal     bool                   `protobuf:"varint,3,opt,name=show_total,json=showTotal,proto3" json:"show_total,omitempty" gorm:"type:tinyint(1);column:show_total;default:0;not null" yaml:"show_total,omitempty" toml:"show_total,omitempty"`
...
type Paginate struct {
	...
	Limit         uint64                 `protobuf:"varint,2,opt,name=limit,proto3" json:"limit,omitempty" gorm:"not null;default:0;column:limit" yaml:"limit,omitempty" toml:"limit,omitempty"`
	Total         uint64                 `protobuf:"varint,3,opt,name=total,proto3" json:"total,omitempty" yaml:"total,omitempty" toml:"total,omitempty" gorm:"not null;default:0;column:total"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Http struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Method        *string                `protobuf:"bytes,1,opt,name=method,proto3,oneof" json:"method,omitempty" yaml:"method,omitempty" toml:"method,omitempty" gorm:"serializer:json;column:method;type:json"`
	Path          *string                `protobuf:"bytes,2,opt,name=path,proto3,oneof" json:"path,omitempty" gorm:"type:json;serializer:json;column:path" yaml:"path,omitempty" toml:"path,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type LazyGen struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	RoleList       []string               `protobuf:"bytes,1,rep,name=role_list,json=roleList,proto3" json:"role_list,omitempty" yaml:"role_list,omitempty" toml:"role_list,omitempty" gorm:"serializer:json;column:role_list;type:json"`                                     // 角色，如 admin/user/public 等
	GenTo          string                 `protobuf:"bytes,2,opt,name=gen_to,json=genTo,proto3" json:"gen_to,omitempty" yaml:"gen_to,omitempty" toml:"gen_to,omitempty" gorm:"not null;default:'';column:gen_to;type:varchar(255)"`                                           // 生成到的文件名，默认使用 impl
	BeforeHandlers []string               `protobuf:"bytes,3,rep,name=before_handlers,json=beforeHandlers,proto3" json:"before_handlers,omitempty" yaml:"before_handlers,omitempty" toml:"before_handlers,omitempty" gorm:"serializer:json;column:before_handlers;type:json"` // 前置拦截器
	...
	Group          string                 `protobuf:"bytes,5,opt,name=group,proto3" json:"group,omitempty" yaml:"group,omitempty" toml:"group,omitempty" gorm:"default:'';column:group;type:varchar(255);not null"`                                                           // 分组
	Name           string                 `protobuf:"bytes,6,opt,name=name,proto3" json:"name,omitempty" yaml:"name,omitempty" toml:"name,omitempty" gorm:"default:'';column:name;type:varchar(255);not null"`                                                                // 接口名
	Desc           string                 `protobuf:"bytes,7,opt,name=desc,proto3" json:"desc,omitempty" yaml:"desc,omitempty" toml:"desc,omitempty" gorm:"type:varchar(255);not null;default:'';column:desc"`                                                                // 接口描述
	Docs           string                 `protobuf:"bytes,8,opt,name=docs,proto3" json:"docs,omitempty" yaml:"docs,omitempty" toml:"docs,omitempty" gorm:"column:docs;type:varchar(255);not null;default:''"`                                                                // 接口文档，长文本的消息描述
	Action         string                 `protobuf:"bytes,9,opt,name=action,proto3" json:"action,omitempty" gorm:"type:varchar(255);not null;default:'';column:action" yaml:"action,omitempty" toml:"action,omitempty"`                                                      // 操作，用于根据 action 寻找对应的模板
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type ListOption_Option struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           int32                  `protobuf:"varint,1,opt,name=key,proto3" json:"key,omitempty" gorm:"not null;default:0;column:key" yaml:"key,omitempty" toml:"key,omitempty"`
	Value         string                 `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" yaml:"value,omitempty" toml:"value,omitempty" gorm:"type:varchar(255);not null;default:'';column:value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_core_proto_rawDesc = "" +
	...
	"\x06action\x18\t \x01(\tR\x06action*\x83\x0e\n" +
	"\aErrCode\x12\v\n" +
