...
func TestBitcaskSetEx(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskTtl(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskExpire(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskSetNx(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskSetNxWithTimeout(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskIncrDecr(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskHashOperations(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskHashIncr(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskSetOperations(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskClean(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
...
func TestBitcaskSetPrefix(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
	...
	// but doesn't affect the actual key storage in bitcask
...
func TestBitcaskErrorCases(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "test_bitcask_*")
	assert.NilError(t, err)
	defer os.RemoveAll(tmpDir)
